# Bash Shell Script for Computing UMLS-based ADR-ADR Similarity (Lin)
#
...
umls-similarity.pl --infile ADR.txt --matrix --config queryconfig --measure lin --username root --password your_password --socket /var/lib/mysql/mysql.sock --database yourumlsdatabase >> umls-sim-lin.txt
